...
import { Book, MoreVertical, Edit2, Move, Trash2, Play, PauseCircle, CheckCircle2 } from 'lucide-react';
...
const DraggableBookCard: React.FC<DraggableBookCardProps> = React.memo(({ book, viewMode, onDragStart, onUpdateProgress, onUpdateStatus, onEdit, onDelete, onMove, onSelect }) => {
