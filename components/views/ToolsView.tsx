      ...
      <div className="flex md:flex-col gap-2 overflow-x-auto pb-2 md:pb-0">
        {TOOLS_MENU.map((item) => (
          <button 
            ...
            className={`flex items-center gap-3 p-4 rounded-xl text-left transition-all min-w-[160px] ${
              activeTool === item.id 
            ...
            <div className="grid grid-cols-4 gap-3">
              {['7','8','9','/','4','5','6','*','1','2','3','-','C','0','=','+'].map(btn => (
                <button 
                  ...
                  className={`p-4 rounded-xl font-bold text-lg transition-transform active:scale-95 ${
                    btn === '=' ? 'bg-indigo-600 hover:bg-indigo-500 text-white col-span-1 shadow-lg shadow-indigo-900/30' : 
