...
import {
  ...
  Target, Clock, Flame, AlertTriangle
} from 'lucide-react';
import { Type } from "@google/genai";
import { Book as IBook, Folder as IFolder, ProjectConfig } from '../../types';
...
const ReadingGoalSidebar: React.FC<{
  books: IBook[];
...
const ReadingView: React.FC = () => {
  ...
  const [projectConfig] = useStorage<ProjectConfig>('p67_project_config', {
  ...
  return (
    <div className="pb-20 animate-in fade-in duration-500 relative">
      ...
      <div className="flex flex-col xl:flex-row gap-6">
        ...
        {/* LEFT SIDEBAR - Reading Goal */}
        <div className="w-full xl:w-80 xl:flex-shrink-0">
          <ReadingGoalSidebar books={books} projectConfig={projectConfig} />
        </div>

        {/* RIGHT CONTENT - Dashboard or Library */}
        <div className="flex-1 min-w-0">
          {activeTab === 'dashboard' ? (
            <DashboardView
              books={books}
