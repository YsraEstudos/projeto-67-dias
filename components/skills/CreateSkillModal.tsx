...
export const CreateSkillModal: React.FC<CreateSkillModalProps> = ({ onClose, onCreate }) => {
    ...
    // Intercept close to check for unsaved changes using isDirty from react-hook-form
    const handleClose = () => {
                ...
                <div className="relative bg-slate-800 w-full max-w-md rounded-2xl border border-slate-700 shadow-2xl overflow-hidden">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className="p-4 border-t border-slate-700 bg-slate-900/50 flex gap-3">
                            <button type="button" onClick={handleClose} className="flex-1 py-3 rounded-xl text-slate-400 hover:bg-slate-800 transition-colors font-medium">Cancelar</button>
