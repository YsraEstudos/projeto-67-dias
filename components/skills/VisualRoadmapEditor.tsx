...
export const VisualRoadmapEditor: React.FC<VisualRoadmapEditorProps> = ({
    ...
    const handleAutoLayout = useCallback((direction: 'TB' | 'LR' = 'LR') => {
        const layouted = getLayoutedElements(nodes, connections, direction);
    ...
    const addNode = (type: VisualNodeType) => {
        ...
        if (transformRef.current) {
            ...
            // This is rough estimation, ideal would be to calc exact viewport center
        ...
        const newNode: VisualRoadmapNode = {
            ...
            type,
            x: centerX - 80, // Offset to center the node
            y: centerY - 20,
            isCompleted: false
        };
    ...
    const updateNode = (id: string, updates: Partial<VisualRoadmapNode>) => {
    ...
    useEffect(() => {
        const handleGlobalMouseMove = (e: MouseEvent) => {
            ...
            // Handle Node Drag
            if (draggingNode && transformRef.current) {
            ...
            <div className="flex-1 flex overflow-hidden">
                ...
                <div className="flex-1 bg-[#1e1e2e] relative overflow-hidden" ref={canvasRef}>
                    ...
                    >
                        ...
                        >
                            <div className="relative w-[5000px] h-[5000px] bg-slate-900/0"> {/* Large container */}
